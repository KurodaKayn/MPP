...
func registerUserDashboardRoutes(e *echo.Echo, config serverConfig, h serverHandlers) error {
	...
	userGroup.GET("/content-templates", h.userDashboard.ListContentTemplates)
	userGroup.POST("/content-templates", h.userDashboard.CreateContentTemplate)
	userGroup.GET("/brand-profiles", h.userDashboard.ListBrandProfiles)
...
func registerWorkspaceRoutes(e *echo.Echo, config serverConfig, h serverHandlers) error {
	...
	workspaceGroup.GET("/:id/content-templates", h.userDashboard.ListWorkspaceContentTemplates)
	workspaceGroup.POST("/:id/content-templates", h.userDashboard.CreateWorkspaceContentTemplate)
	workspaceGroup.GET("/:id/brand-profiles", h.userDashboard.ListWorkspaceBrandProfiles)
	workspaceGroup.POST("/:id/brand-profiles", h.userDashboard.CreateWorkspaceBrandProfile)
	workspaceGroup.GET("/:id/activity", h.userDashboard.ListWorkspaceActivities)
	workspaceGroup.GET("/:id/publication-calendar", h.userDashboard.ListWorkspacePublicationCalendar)
