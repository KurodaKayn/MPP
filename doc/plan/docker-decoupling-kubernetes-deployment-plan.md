...
| K8S-023 | Add Kubernetes production setup guide | Documentation | Partially Done | 65% | Documentation | `doc/setup-kubernetes.md` documents prerequisites, overlays, secrets, data services, runtime selection, validation, and deployment flow; provider-specific overlays remain future work. |
| K8S-024 | Add Kubernetes operations runbooks | Operations | Partially Done | 35% | Documentation / DevOps | `doc/setup-kubernetes.md` includes initial rollback, runtime cleanup, scaling, secret rotation, and backup responsibility notes; deeper alerting and incident runbooks remain future work. |
