...
| K8S-015 | Support managed PostgreSQL configuration | Data services | Partially Done | 70% | DevOps / Backend | `deploy/kubernetes/data-services/managed` provides a PostgreSQL ExternalName, and backend/collab-service support `DB_SSLMODE` and `DB_SSLROOTCERT`; provider-specific overlays remain future work. |
