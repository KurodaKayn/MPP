...
Current overall progress: about `67%`. This number is manually estimated by phase weight and can be adjusted later according to actual completed items.
